          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <!-- spuSaleAttrValue代表点击的内容， spuSaleAttr.spuSaleAttrValueList代表整个属性数组（排他思想） -->
                <dd
                  changepirce="0"
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里的路由跳转之前，发请求，把购买的产品信息以请求的形式发给服务器 -->
...
export default {
  ...
  mounted() {
    //派发action向服务器发请求,getGoodsInfo是atcion的名字，后面是参数
  ...
  methods: {
    //排他思想解决鼠标选择高亮
    //定义两个参数saleAttrValue, arr接收click事件传来的入参
    ...
    //表单元素，修改购买产品的数量,event获取值
    changeSkuNum(event) {
      //乘以1对用户输入的其他字符做个处理，*1=NaN
    ...
    // 加入购物车的回调函数,加入购物车服务器没有返回数据，只是返回状态
    async addShopCart() {
      try {
        ...
        //跳转路由 //产品信息带给兄弟组件  // console.log(this.$route.params);// console.log(result);
        //通过‘参数’+‘回话存储’的形式传递数据，详情内容数据用‘会话存储’
